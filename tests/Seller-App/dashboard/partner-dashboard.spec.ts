...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Enter Email ID or Phone Number').fill('ms_partner@tmail.com');
  ...
  await page.getByRole('button', { name: 'MS Test Partner' }).click();
  await page.getByText('Total Revenue').click();
  await page.getByText('Total Revenue').click();
  await page.getByText('Total Partners0').click();
