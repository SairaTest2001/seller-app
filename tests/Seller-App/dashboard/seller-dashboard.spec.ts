...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Enter Email ID or Phone Number').fill('ms_test_store@tmail.in');
  ...
  await page.getByRole('button', { name: 'MS Test Store Powered by Adya' }).click();
  ...
  await page.getByText('Active Products').click();
  await page.getByRole('link', { name: 'Seller Dashboard' }).click();
